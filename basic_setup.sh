# TomS's stuff# ln -sf ~/.my-osx-setup/bashrc ~/.bashrc
# TomS's stuff# ln -sf ~/.my-osx-setup/bash_aliases ~/.bash_aliases
# TomS's stuff# ln -sf ~/.my-osx-setup/screen-keys.conf ~/.tmux.conf
# TomS's stuff# ln -sf ~/.my-osx-setup/gitconfig ~/.gitconfig
# TomS's stuff# ln -sf ~/.my-osx-setup/vimrc ~/.vimrc
# TomS's stuff# touch ~/.localbashrc
# TomS's stuff# touch ~/.localbash_aliases
# TomS's stuff# touch ~/.localgitconfig
# TomS's stuff# touch ~/.localvimrc
# TomS's stuff#
